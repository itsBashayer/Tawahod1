                ...
                ZStack {
                    ...
                    VStack(spacing: 20) {
                        ...
                        HStack(spacing: 30) {
                            ...
                            SquareButton(imageName: "image4", soundName: "hug", cornerRadius: 10, width: 150, height: 150)
                        }
                        HStack(spacing: 30) {
                            SquareButton(imageName: "image5", soundName: "play", cornerRadius: 10, width: 150, height: 150)
